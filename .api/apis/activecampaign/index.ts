...
class SDK {
   ...
   * @throws FetchError<400, types.ListPersonalizationsResponse400> 400
   */
  listPersonalizations(metadata?: types.ListPersonalizationsMetadataParam): Promise<FetchResponse<200, types.ListPersonalizationsResponse200>> {
   ...
   */
  createPersonalization(body?: types.CreatePersonalizationBodyParam): Promise<FetchResponse<200, types.CreatePersonalizationResponse200>> {
   ...
   * @throws FetchError<404, types.RetrievePersonalizationResponse404> 404
   */
  retrievePersonalization(metadata: types.RetrievePersonalizationMetadataParam): Promise<FetchResponse<200, types.RetrievePersonalizationResponse200>> {
    return this.core.fetch('/personalizations/{personalizationID}', 'get', metadata);
  }

  /**
   * Edit a personalization variable
   *
   * @summary Edit a Personalization
   * @throws FetchError<404, types.EditPersonalizationResponse404> 404
   */
  editPersonalization(body: types.EditPersonalizationBodyParam, metadata: types.EditPersonalizationMetadataParam): Promise<FetchResponse<200, types.EditPersonalizationResponse200>>;
  editPersonalization(metadata: types.EditPersonalizationMetadataParam): Promise<FetchResponse<200, types.EditPersonalizationResponse200>>;
  editPersonalization(body?: types.EditPersonalizationBodyParam | types.EditPersonalizationMetadataParam, metadata?: types.EditPersonalizationMetadataParam): Promise<FetchResponse<200, types.EditPersonalizationResponse200>> {
    return this.core.fetch('/personalizations/{personalizationID}', 'put', body, metadata);
  }
   ...
   * @throws FetchError<400, types.DeletePersonalizationResponse400> 400
   */
  deletePersonalization(metadata: types.DeletePersonalizationMetadataParam): Promise<FetchResponse<200, types.DeletePersonalizationResponse200>> {
    return this.core.fetch('/personalizations/{personalizationID}', 'delete', metadata);
  }

  /**
   * Bulk delete personalization variables
   *
   * @summary Bulk Delete Personalizations
   */
  bulkDeletePersonalizations(metadata?: types.BulkDeletePersonalizationsMetadataParam): Promise<FetchResponse<200, types.BulkDeletePersonalizationsResponse200>> {
